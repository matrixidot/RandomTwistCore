            ...
            while ((entities.size() <= 0 || entities.contains(this.owner)) && length <= this.size * 100.0D) {
                ...
                if (this.showRayCast) {
                    if (this.particle == Particle.REDSTONE)
                        this.world.spawnParticle(particle, this.rayCastLocation.getX(), this.rayCastLocation.getY(), this.rayCastLocation.getZ(), 1, 0.2D, 0.2D, 0.2D, new Particle.DustOptions(Color.ORANGE, 0.25f));
                    else
                        this.world.spawnParticle(particle, this.rayCastLocation.getX(), this.rayCastLocation.getY(), this.rayCastLocation.getZ(), 0, 0.05, 0.05, 0.05);
